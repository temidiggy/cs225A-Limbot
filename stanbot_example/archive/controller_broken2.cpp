...
int main() {
	...
	vector<int> joint_selection{0,1,2};
	...
	joint_task_right_foot->_saturation_velocity << 0, 0.2, 0; 
	...
	VectorXd desired_right_foot_position(1);
	desired_right_foot_position(0) = right_foot_pos_init(1) + 0.1;
	...
	//	std::cout << robot->_q.size() << "\n";
		...
		VectorXd right_foot_pose_desired(1);
		right_foot_pose_desired(0) = right_foot_pos_init(1) + 0.1; // + Vector3d(0.2 * cos(time), 0.2 * cos(time), 0.2 * cos(time));


		// set controller inputs
		posori_task_left_foot->_desired_position = left_foot_pose_desired;
		joint_task_right_foot->_desired_position = desired_right_foot_position;
		...
		*/ 
		...
		joint_task_right_foot->computeTorques(joint_task_torques_right_foot);
		...
		*/ 
		...
		//command_torques = posori_task_torques_left_foot+ joint_task_torques_right_foot;
		command_torques = posori_task_torques_left_foot;
