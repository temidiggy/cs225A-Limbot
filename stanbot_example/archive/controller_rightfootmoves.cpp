...
int main() {
	...
	while (runloop) {
		...
		// calculate torques for skate
		N_prec.setIdentity();
		skate_task->_desired_position(0) = 0.5;
		skate_task->_desired_position(1) = 0.5;
		skate_task->_desired_position(2) = 0.2;  // radians 
